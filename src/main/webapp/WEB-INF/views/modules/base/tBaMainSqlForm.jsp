...
<div class="box box-primary" >
	...
	<form:form id="inputForm" modelAttribute="TBaMainSql" action="${ctx}/base/tBaMainSql/saveMainSql" method="post" class="form-horizontal">
		...
		<div class="bg-gray-light callout" style="padding: 15px">
		...
		<div class="form-group">
			...
			<div class="controls">
				<form:textarea path="headSql" htmlEscape="false" rows="4" maxlength="400" class="input-xxlarge required checkIsSql form-control"/>
			    &nbsp;&nbsp;
		...
		<div class="form-group">
			...
			<div class="controls">
				<form:textarea path="remarks" htmlEscape="false" rows="4" maxlength="400" class="input-xxlarge form-control"/>
			</div>
		</div>
		<div class="bg-gray-light callout" style="padding: 15px">
            <div class="span5">
        ...
        <table id="contentTable" class="table table-striped table-bordered table-condensed" >
            ...
            <tr id="copyTr" style="display: none;">
				<td><input id="codeName" type="text" style="width: 90px;" class="form-control" />
				</td>
				<td><input id="fieldSort" type="text" style="width: 30px;" class="form-control" />
				</td>
				<td><label id="psLabel"></label>
				</td>
				<td><input id="fieldInput" type="text" style="width: 90px;"  class="form-control"/>
				</td>
				<td>
                    <select id="fieldType" style="width: 90px;" class="form-control">
                        <option value="1">字符串类型</option>
                        <option value="2">日期类型</option>
                    </select>
                </td>
                <td>
                    <select id="isShow" style="width: 50px;" class="form-control">
                        <option value="1">是</option>
                        <option value="2">否</option>
                    </select>
                </td>
                <td><input id="fieldHref" type="text" style="width: 90px;" class="form-control"/></td>
                <td>
                    <select id="selectModel" style="width: 90px;" class="form-control">
                        <option value="1">精确查询</option>
                        <option value="2">模糊查询</option>
                        <option value="2">范围查询</option>
                    </select>
                </td>
                <td><input id="selectType" type="text" style="width: 90px;" class="form-control"/></td>
                <td><input id="dictCode" type="text" style="width: 90px;" class="form-control"/></td>
                <td>
                    <select id="isSelect" style="width: 50px;" class="form-control">
                        <option value="1">是</option>
                        <option value="2">否</option>
                    </select>
                </td>
                ...
                <tr  class="addData">
	                <td>
	                    <input id="fieldList[${fieldIndex.index}]CodeName" type="text" value="${fieldObj.codeName}"
	                        style="width: 90px;" name="fieldList[${fieldIndex.index}].codeName" class="form-control"/>
	                </td>
					<td>
					    <input id="fieldList[${fieldIndex.index}]FieldSort" type="text" value="${fieldObj.fieldSort}"
					        style="width: 30px;" name="fieldList[${fieldIndex.index}].fieldSort" class="form-control"/>
					</td>
					<td>
					    <label id="fieldList[${fieldIndex.index}]PsLabel">${fieldObj.physicsType}(${fieldObj.physicsLength})</label>
					    <input type="hidden" name="fieldList[${fieldIndex.index}].physicsType" value="${fieldObj.physicsType}" class="form-control"/>
					    <input type="hidden" name="fieldList[${fieldIndex.index}].physicsLength" value="${fieldObj.physicsLength}" class="form-control"/>
					</td>
					<td>
					    <input id="fieldList[${fieldIndex.index}]FieldInput" type="text" value="${fieldObj.fieldInput}"
					        style="width: 90px;" name="fieldList[${fieldIndex.index}].fieldInput" class="form-control"/>
					</td>
					<td>
	                    <select id="fieldList[${fieldIndex.index}]FieldType" style="width: 90px;" name="fieldList[${fieldIndex.index}].fieldType" class="form-control">
	                ...
	                <td>
	                    <select id="fieldList[${fieldIndex.index}]IsShow" style="width: 50px;" name="fieldList[${fieldIndex.index}].isShow" class="form-control">
	                ...
	                <td>
	                    <input id="fieldList[${fieldIndex.index}]FieldHref" type="text"  value="${fieldObj.fieldHref}"
	                        style="width: 90px;" name="fieldList[${fieldIndex.index}].fieldHref" class="form-control"/>
	                </td>
	                <td>
	                    <select id="fieldList[${fieldIndex.index}]SelectModel" style="width: 90px;" name="fieldList[${fieldIndex.index}].selectModel" class="form-control">
					...
					<td>
					    <input id="fieldList[${fieldIndex.index}]SelectType" type="text" style="width: 90px;" value="${fieldObj.selectType}"
					        name="fieldList[${fieldIndex.index}].selectType" class="form-control"/>
					</td>
					<td><input id="fieldList[${fieldIndex.index}]DictCode" type="text" style="width: 90px;" value="${fieldObj.dictCode }"
					        name="fieldList[${fieldIndex.index}].dictCode" class="form-control"/>
					</td>
					<td>
	                    <select id="fieldList[${fieldIndex.index}]IsSelect" style="width: 50px;" name="fieldList[${fieldIndex.index}].isSelect" class="form-control">
