...
<div class="box box-primary" >
	...
	<form:form id="inputForm" modelAttribute="TBaParameter" action="${ctx}/base/tBaParameter/save" 
        ...
        <div class="form-group">
            ...
            <div class="controls">
                <form:input path="paraName" htmlEscape="false" maxlength="32" class="form-control "/>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label">参数键：</label>
            <div class="controls">
                <form:input path="paraKey" htmlEscape="false" maxlength="20" class="form-control "/>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label">参数值：</label>
            <div class="controls">
                <form:input path="paraValue" htmlEscape="false" maxlength="20" class="form-control "/>
            </div>
        </div>
		<div class="form-group">
            <label class="control-label">参数类型：</label>
            <div class="controls">
                <form:select path="paraType" class="form-control ">
		...
		<div class="form-group">
			...
			<div class="controls">
				<select name="useState" style="width: 120px;" class="form-control ">
