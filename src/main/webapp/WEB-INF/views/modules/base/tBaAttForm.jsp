...
<div class="box box-primary" >
	...
	<form:form id="inputForm" modelAttribute="TBaAtt"  enctype="multipart/form-data"
		...
		<div class="form-group">
			...
			<div class="controls">
				<form:input path="name" htmlEscape="false" maxlength="10" class="form-control "/>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="controls">
				<sys:treeselect id="office" name="office.id" value="${tBaAtt.office.id}" 
					...
					title="部门" url="/sys/office/treeData?type=2" cssClass="required form-control" allowClear="true"
        ...
        <div class="form-group">
            ...
            <div class="controls">
                <select name="isrequired" style="width: 120px;"class="form-control">
		...
		<div class="form-group">
            ...
            <div class="controls">
                <input name="sort"   type="text"  value="${tBaAtt.sort }"
