	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<div class="form-group" style="display: none">
			...
			<div class="controls">
				...
				<%--<form:select path="type" class="input-medium form-control form-control">--%>
		...
		<div class="form-group" style="display: none">
			...
			<div class="controls">
				<input name="grade" value="1">
				<%--<form:select path="grade" class="input-medium form-control form-control">--%>
		...
		<%--<c:if test="${empty office.id}">--%>
			<%--<div class="form-group">--%>
				...
				<%--<div class="controls">--%>
					<%--<form:checkboxes path="childDeptList" items="${fns:getDictList('sys_office_common')}" itemLabel="label" itemValue="value" htmlEscape="false" cssClass="flat-blue"/>--%>
				<%--</div>--%>
			<%--</div>--%>
		<%--</c:if>--%>
