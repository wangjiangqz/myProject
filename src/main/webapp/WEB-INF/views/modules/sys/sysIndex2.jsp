				...
				if ($(menuId).length > 0){
					...
					$.get($(this).attr("data-href"), function(data){
						...
						$(menuId + " .accordion-body a").click(function(){
							...
							$(menuId + " li i").removeClass("glyphicon glyphicon-white");
							$(this).parent().addClass("active");
		...
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right"><%--
					<li><a href="${pageContext.request.contextPath}${fns:getFrontPath()}/index-${fnc:getCurrentSiteId()}.html" target="_blank" title="访问网站主页"><i class="glyphicon glyphicon-home"></i></a></li>--%>
					...
					<li id="userInfo" class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="${ctx}/sys/user/info" target="mainFrame"><i class="glyphicon glyphicon-user"></i>&nbsp; 个人信息</a></li>
							<li><a href="${ctx}/sys/user/modifyPwd" target="mainFrame"><i class="glyphicon glyphicon-lock"></i>&nbsp;  修改密码</a></li>
							<li><a href="${ctx}/oa/oaNotify/self" target="mainFrame"><i class="glyphicon glyphicon-bell"></i>&nbsp;  我的通知 <span id="notifyNum2" class="label label-info hide"></span></a></li>
						</ul>
					</li>
