...
<div class="box box-primary" >
	...
	<div class="box-body">
	<form:form id="searchForm" modelAttribute="genTable" action="${ctx}/gen/genTable/" method="post" class="breadcrumb form-search bg-gray-light callout">
		...
		<c:forEach items="${page.list}" var="genTable">
			<tr>
				...
				<shiro:hasPermission name="gen:genTable:edit"><td>
					...
					<a href="${ctx}/gen/genTable/delete?id=${genTable.id}" onclick="return confirmx('确认要删除该业务表吗？', this.href)" class="btn  btn-danger btn-xs"><i class="fa fa-close"></i>删除</a>
