...
<div class="box box-primary" >
	...
	<form:form id="inputForm" modelAttribute="genScheme" action="${ctx}/gen/genScheme/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="controls">
				<form:select path="category" class="required form-control" cssStyle="width: 350px">
		...
		<div class="form-group">
			...
			<div class="controls">
				<form:select path="genTable.id" class="required form-control" cssStyle="width: 350px">
		...
		<div class="form-group">
			...
			<div class="controls">
				<form:checkbox path="replaceFile" label="是否替换现有文件" cssClass="flat-blue"/>
			</div>
		</div>
