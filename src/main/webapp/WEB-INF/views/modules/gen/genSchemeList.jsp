...
<div class="box box-primary" >
	...
	<div class="box-body">
	<form:form id="searchForm" modelAttribute="genScheme" action="${ctx}/gen/genScheme/" method="post" class="breadcrumb form-search bg-gray-light callout">
		...
		<c:forEach items="${page.list}" var="genScheme">
			<tr>
				...
				<shiro:hasPermission name="gen:genScheme:edit"><td>
					...
					<a href="${ctx}/gen/genScheme/delete?id=${genScheme.id}" onclick="return confirmx('确认要删除该生成方案吗？', this.href)" class="btn   btn-danger btn-xs"><i class="fa fa-close"></i>删除</a>
