...
import com.base.common.security.Digests;
import com.base.common.security.shiro.session.SessionDAO;
import com.base.common.service.BaseService;
import com.base.common.service.ServiceException;
import com.base.common.utils.CacheUtils;
import com.base.common.utils.Encodes;
import com.base.common.utils.StringUtils;
import com.base.modules.sys.dao.MenuDao;
import com.base.modules.sys.dao.RoleDao;
import com.base.modules.sys.dao.UserDao;
...
public class SystemService extends BaseService implements InitializingBean {
	...
	public List<User> getUserAndId(Map<String, Object> condition){
	    return userDao.getUserAndId(condition);
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
    ...
    public List<User> checkUserAndMob(User user) {
        return userDao.checkUserAndMob(user);
    }
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By 版权\r\n");
		sb.append("\r\n======================================================================\r\n");
