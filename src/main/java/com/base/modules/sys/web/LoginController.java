...
import com.base.modules.sys.security.FormAuthenticationFilter;
...
//		view += ".jsp";
	...
	public String index(HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		String vaildPwd = principal.getVaildPwd();
		model.addAttribute("vaildPwd",vaildPwd);
...
//		try {
//			byte[] bytes = com.base.common.utils.FileUtils.readFileToByteArray(
//					com.base.common.utils.FileUtils.getFile("c:\\sxt.dmp"));
