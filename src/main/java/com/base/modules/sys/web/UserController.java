...
import com.base.modules.base.service.TBaAttService;
...
import com.base.common.beanvalidator.BeanValidators;
import com.base.common.config.Global;
import com.base.common.persistence.Page;
import com.base.common.utils.DateUtils;
import com.base.common.utils.StringUtils;
import com.base.common.utils.excel.ExportExcel;
import com.base.common.utils.excel.ImportExcel;
...
public class UserController extends BaseController {
	...
	public String homePage(HttpServletRequest request, HttpServletResponse response, Model model) {
		User user = UserUtils.getUser();
		model.addAttribute("user",user);
		TBaAtt tBaAtt=new TBaAtt();
		Dict dict=new Dict();
		dict.setLabel("首页附件");
		tBaAtt.setType(dict);
		List<TBaAtt>tBaAtts=tBaAttService.findList(tBaAtt);
		model.addAttribute("tBaAtts", tBaAtts);
