...
package com.base.common.ema.sso.nbtravel;

public class CreateUserImpServiceLocator extends org.apache.axis.client.Service implements com.base.common.ema.sso.nbtravel.CreateUserImpService {
    ...
    public com.base.common.ema.sso.nbtravel.ICreateUser getCreateUserImpPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.base.common.ema.sso.nbtravel.ICreateUser getCreateUserImpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.base.common.ema.sso.nbtravel.CreateUserImpServiceSoapBindingStub _stub = new com.base.common.ema.sso.nbtravel.CreateUserImpServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.base.common.ema.sso.nbtravel.ICreateUser.class.isAssignableFrom(serviceEndpointInterface)) {
                com.base.common.ema.sso.nbtravel.CreateUserImpServiceSoapBindingStub _stub = new com.base.common.ema.sso.nbtravel.CreateUserImpServiceSoapBindingStub(new java.net.URL(CreateUserImpPort_address), this);
                _stub.setPortName(getCreateUserImpPortWSDDServiceName());
                return _stub;
            }
        }
