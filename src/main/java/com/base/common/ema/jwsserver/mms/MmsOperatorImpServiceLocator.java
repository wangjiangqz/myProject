...
public class MmsOperatorImpServiceLocator extends org.apache.axis.client.Service implements com.base.common.ema.jwsserver.mms.MmsOperatorImpService {
    ...
    public com.base.common.ema.jwsserver.mms.IMmsOperator getMmsOperatorImpPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.base.common.ema.jwsserver.mms.IMmsOperator getMmsOperatorImpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.base.common.ema.jwsserver.mms.MmsOperatorImpServiceSoapBindingStub _stub = new com.base.common.ema.jwsserver.mms.MmsOperatorImpServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.base.common.ema.jwsserver.mms.IMmsOperator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.base.common.ema.jwsserver.mms.MmsOperatorImpServiceSoapBindingStub _stub = new com.base.common.ema.jwsserver.mms.MmsOperatorImpServiceSoapBindingStub(new java.net.URL(MmsOperatorImpPort_address), this);
                _stub.setPortName(getMmsOperatorImpPortWSDDServiceName());
                return _stub;
            }
        }
