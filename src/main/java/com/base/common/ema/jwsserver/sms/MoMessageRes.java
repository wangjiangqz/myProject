...
public class MoMessageRes  implements java.io.Serializable {
    private com.base.common.ema.jwsserver.sms.MoMessageResDetail[] resDetail;
    ...
    public MoMessageRes(
           com.base.common.ema.jwsserver.sms.MoMessageResDetail[] resDetail,
     ...
     * @return resDetail
     */
    public com.base.common.ema.jwsserver.sms.MoMessageResDetail[] getResDetail() {
        return resDetail;
    }
     ...
     * @param resDetail
     */
    public void setResDetail(com.base.common.ema.jwsserver.sms.MoMessageResDetail[] resDetail) {
        this.resDetail = resDetail;
    }

    public com.base.common.ema.jwsserver.sms.MoMessageResDetail getResDetail(int i) {
        return this.resDetail[i];
    }

    public void setResDetail(int i, com.base.common.ema.jwsserver.sms.MoMessageResDetail _value) {
