...
public class ContactsService4JSONImplServiceLocator extends org.apache.axis.client.Service implements com.base.common.ema.jwsserver.sms.contacts.ContactsService4JSONImplService {
    ...
    public com.base.common.ema.jwsserver.sms.contacts.IContactsService4JSON getContactsService4JSONImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.base.common.ema.jwsserver.sms.contacts.IContactsService4JSON getContactsService4JSONImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.base.common.ema.jwsserver.sms.contacts.ContactsService4JSONImplServiceSoapBindingStub _stub = new com.base.common.ema.jwsserver.sms.contacts.ContactsService4JSONImplServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.base.common.ema.jwsserver.sms.contacts.IContactsService4JSON.class.isAssignableFrom(serviceEndpointInterface)) {
                com.base.common.ema.jwsserver.sms.contacts.ContactsService4JSONImplServiceSoapBindingStub _stub = new com.base.common.ema.jwsserver.sms.contacts.ContactsService4JSONImplServiceSoapBindingStub(new java.net.URL(ContactsService4JSONImplPort_address), this);
                _stub.setPortName(getContactsService4JSONImplPortWSDDServiceName());
                return _stub;
            }
        }
