...
public class SmsOperatorImpInterServiceLocator extends org.apache.axis.client.Service implements com.base.common.ema.jwsserver.smsinter.SmsOperatorImpInterService {
    ...
    public com.base.common.ema.jwsserver.smsinter.ISmsOperatorInter getSmsOperatorImpInterPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.base.common.ema.jwsserver.smsinter.ISmsOperatorInter getSmsOperatorImpInterPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.base.common.ema.jwsserver.smsinter.SmsOperatorImpInterServiceSoapBindingStub _stub = new com.base.common.ema.jwsserver.smsinter.SmsOperatorImpInterServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.base.common.ema.jwsserver.smsinter.ISmsOperatorInter.class.isAssignableFrom(serviceEndpointInterface)) {
                com.base.common.ema.jwsserver.smsinter.SmsOperatorImpInterServiceSoapBindingStub _stub = new com.base.common.ema.jwsserver.smsinter.SmsOperatorImpInterServiceSoapBindingStub(new java.net.URL(SmsOperatorImpInterPort_address), this);
                _stub.setPortName(getSmsOperatorImpInterPortWSDDServiceName());
                return _stub;
            }
        }
