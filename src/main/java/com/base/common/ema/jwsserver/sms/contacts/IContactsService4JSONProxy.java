...
public class IContactsService4JSONProxy implements com.base.common.ema.jwsserver.sms.contacts.IContactsService4JSON {
  private String _endpoint = null;
  private com.base.common.ema.jwsserver.sms.contacts.IContactsService4JSON iContactsService4JSON = null;
  ...
  private void _initIContactsService4JSONProxy() {
    try {
      iContactsService4JSON = (new com.base.common.ema.jwsserver.sms.contacts.ContactsService4JSONImplServiceLocator()).getContactsService4JSONImplPort();
  ...
  public com.base.common.ema.jwsserver.sms.contacts.IContactsService4JSON getIContactsService4JSON() {
    if (iContactsService4JSON == null)
      _initIContactsService4JSONProxy();
