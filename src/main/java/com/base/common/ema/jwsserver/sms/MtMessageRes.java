...
public class MtMessageRes  implements java.io.Serializable {
    private com.base.common.ema.jwsserver.sms.MtMessageResDetail[] resDetail;
    ...
    public MtMessageRes(
           com.base.common.ema.jwsserver.sms.MtMessageResDetail[] resDetail,
     ...
     * @return resDetail
     */
    public com.base.common.ema.jwsserver.sms.MtMessageResDetail[] getResDetail() {
        return resDetail;
    }
     ...
     * @param resDetail
     */
    public void setResDetail(com.base.common.ema.jwsserver.sms.MtMessageResDetail[] resDetail) {
        this.resDetail = resDetail;
    }

    public com.base.common.ema.jwsserver.sms.MtMessageResDetail getResDetail(int i) {
        return this.resDetail[i];
    }

    public void setResDetail(int i, com.base.common.ema.jwsserver.sms.MtMessageResDetail _value) {
