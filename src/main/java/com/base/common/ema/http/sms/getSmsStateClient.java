package com.base.common.ema.http.sms;
 ...
 * @version 1.0
 */
public class getSmsStateClient {
    /** log4J*/
    private static final Logger log = Logger.getLogger(getSmsStateClient.class);

    public static void main(String[] args) {
        String url = "http://127.0.0.1:8080/ctc-emassh60/httpSms/getSmsState";
        String account = "zh";
    ...
    public static void getSms(String url, String account, String password) {
        ...
        try {
            ...
            if (_sedrespContent != null) {
                log.info("\n\n getSmsState Res:" + _sedrespContent);
            }
        } catch (Exception e) {
            e.printStackTrace();
            log.error("e :" + e);
